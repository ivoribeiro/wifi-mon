...
void addDestination(struct DestinationList* list, const uint8_t* mac_address) {
    ...
    while (current != NULL) {
        if (memcmp(current->mac_address, mac_address, 6) == 0) {
            ...
            //printf("Destination %02X:%02X:%02X:%02X:%02X:%02X already exists.\n",
    ...
    printf("Added new destination %02X:%02X:%02X:%02X:%02X:%02X.\n",
           mac_address[0], mac_address[1], mac_address[2], mac_address[3], mac_address[4], mac_address[5]);
}
...
void removeDestination(struct DestinationList* list, const uint8_t* mac_address) {
    ...
    while (current != NULL) {
        if (memcmp(current->mac_address, mac_address, 6) == 0) {
            ...
            printf("Destination with MAC address %02X:%02X:%02X:%02X:%02X:%02X removed.\n",
                   mac_address[0], mac_address[1], mac_address[2], mac_address[3], mac_address[4], mac_address[5]);
            return;
        }
        prev = current;
    ...
    printf("Destination with MAC address %02X:%02X:%02X:%02X:%02X:%02X not found.\n",
           mac_address[0], mac_address[1], mac_address[2], mac_address[3], mac_address[4], mac_address[5]);
}
...
void addClient(struct ClientList* list, const uint8_t* mac_address, const uint8_t* dest_mac_address) {
    ...
    while (current != NULL) {
        if (memcmp(current->mac_address, mac_address, 6) == 0) {
            //printf("Trying to add destination %02X:%02X:%02X:%02X:%02X:%02X to existing client with MAC address %02X:%02X:%02X:%02X:%02X:%02X.\n",
    ...
    printf("Added new client with MAC address %02X:%02X:%02X:%02X:%02X:%02X and destination %02X:%02X:%02X:%02X:%02X:%02X.\n",
           mac_address[0], mac_address[1], mac_address[2], mac_address[3], mac_address[4], mac_address[5],
           dest_mac_address[0], dest_mac_address[1], dest_mac_address[2], dest_mac_address[3], dest_mac_address[4], dest_mac_address[5]);
}
...
void removeClient(struct ClientList* list, const uint8_t* client_mac_address, const uint8_t* dest_mac_address) {
    ...
    while (current != NULL) {
        if (memcmp(current->mac_address, client_mac_address, 6) == 0) {
            ...
            printf("Client with MAC address %02X:%02X:%02X:%02X:%02X:%02X disassociated from destination %02X:%02X:%02X:%02X:%02X:%02X.\n",
    ...
    //printf("Client with MAC address %02X:%02X:%02X:%02X:%02X:%02X not found.\n",
    //       client_mac_address[0], client_mac_address[1], client_mac_address[2],
    //       client_mac_address[3], client_mac_address[4], client_mac_address[5]);
}
